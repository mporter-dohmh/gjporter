...
{return IWCreatePhotocast("http://home.comcast.net/%7Egjporter/Parks/NationalParks/Pages/Yosemite_%28Black_and_White%29_files/rss.xml",true);}
...
IWLayoutPhotoGrid('id2',new IWPhotoGridLayout(4,new IWSize(124,124),new IWSize(124,0),new IWSize(153,139),27,27,0,new IWSize(0,0)),new IWEmptyStroke(),imageStream,range,null,null,1.000000,{backgroundColor:'rgb(0, 0, 0)',reflectionHeight:0,reflectionOffset:2,captionHeight:0,fullScreen:0,transitionIndex:2},'../../Media/slideshow.html','widget0','widget1','widget2')});}
...
loadMozillaCSS('Yosemite_(Black_and_White)_files/Yosemite_(Black_and_White)Moz.css')
